...
[![PyPI version](https://badge.fury.io/py/cache-lru.svg)](https://pypi.org/project/cache-lru/)
...
result = lru("Hello World")

# Example 2: Batch processing
from cache_lru import batch
